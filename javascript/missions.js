...
function missionOne() {
	document.getElementById("inputNameButton").addEventListener(`click`, () => {
...
function missionTwo() {
	document.getElementById("missiononebutton").addEventListener(`click`, () => {
		let text = "";
		const str = document.getElementById("missionone").value;
